...
The project uses [PHPUnit](https://phpunit.de/) framework to run unit tests. The tests are all located in the [`tests` folder](https://github.com/andrewgjohnson/linebreaks4imagettftext/tree/master/tests). All tests should continue to pass and all new features should ideally include unit tests. Run this command to execute all unit tests:

    composer phpunit

### Online Documentation

The project’s online documentation is available at [linebreaks4imagettftext.agjgd.org](https://linebreaks4imagettftext.agjgd.org/). Please ensure the documentation is updated along with any code changes. All of the files used to generate the documentation are in the [`documentation` folder](https://github.com/andrewgjohnson/linebreaks4imagettftext/blob/master/documentation/). [The website](https://linebreaks4imagettftext.agjgd.org/) is powered by [GitHub Pages](https://pages.github.com/) which uses [Jekyll](https://jekyllrb.com/). Run this command to test the online documentation website locally if you have Jekyll installed:
...
In order to participate your behaviour must conform to our [code of conduct](https://github.com/andrewgjohnson/linebreaks4imagettftext/blob/master/.github/CODE_OF_CONDUCT.md).